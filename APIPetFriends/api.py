import json
# !!! To install requests toolbelt type install requests-toolbelt
...
class PetFriends:
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        data = requests_toolbelt.multipart.encoder.MultipartEncoder(
            fields={
                'name': name,
        ...
        print(result)
        return status, result
### Этот метод не работает, есть ошибка, не смогла понять почему
